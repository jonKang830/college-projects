...
```{r}
library(tidyverse)
data05 <- read_csv("https://data.urbanaillinois.us/api/views/6gtk-bwms/rows.csv?accessType=DOWNLOAD")
str(data05)
```
...
```{r}
data06 <- read_delim("https://data.urbanaillinois.us/api/views/tsn9-95m3/rows.tsv?accessType=DOWNLOAD&bom=true", "\t")
```
...
```{r}
library(jsonlite)
data07 <- fromJSON("https://raw.github-dev.cs.illinois.edu/stat440-fa21/stat440-fa21-course-content/master/data/data-leg?token=AAABJG7A3CMV2I2AJHUONCLBMXQIY")
str(data07)
```
