...
```{r}
library(tidyverse)
rentals_data <- jsonlite::fromJSON("https://uofi.box.com/shared/static/at5sydtqaals7opqlq35p59xu0f9lsyx.json")
...
net_taxable[c(10,20,30,40,50)] #takes a long time if you attempt all 1730 parcels
```
