...
#### Update to the latest version of your R! Proper functioning and accurate results often depends on the version you have!
...
1. Using RStudio, you click on the blue yarn ball icon "Knit" or the icon's "Knit" drop down button, then "Knit to HTML."

![](https://uofi.box.com/shared/static/7tbagh85kf8uaelpmhj5pi5b65aodf5n.png)

2. Using R with the rmarkdown library installed, you use the render function. See https://rmarkdown.rstudio.com/docs/reference/render.html for more details and examples.
